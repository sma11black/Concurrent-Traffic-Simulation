...
int main()
{
	...
	// Task: Vary the number of simulated vehicles and use top function on the terminal or
	// the task manager of system to observe the number of threads used by the simulation.
	int nVehicles = 4;
